...
For Codex, Codex, Copilot, or other agents, create `.learnings/` in your project:
...
### Add reference to agent files AGENTS.md, AGENTS.md, or .github/copilot-instructions.md to remind yourself to log learnings. (this is an alternative to hook-based reminders)
...
2. Review and promote broadly applicable learnings to:
   - `AGENTS.md` - project facts and conventions

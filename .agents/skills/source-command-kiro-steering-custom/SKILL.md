---
name: "source-command-kiro-steering-custom"
description: "Create custom steering documents for specialized project contexts"
---

# source-command-kiro-steering-custom

Use this skill when the user asks to run the migrated source command `kiro-steering-custom`.
